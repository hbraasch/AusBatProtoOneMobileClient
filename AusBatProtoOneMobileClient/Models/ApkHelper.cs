...
{
    // Helper to assist with providing additional data, if for Android, the APK file exceeds 100 MB. In our case we need to upload the
    ...
    // This size limitation does not exist for iOS 
