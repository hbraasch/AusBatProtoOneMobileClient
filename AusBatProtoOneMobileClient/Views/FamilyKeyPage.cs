...
namespace DocGenOneMobileClient.Views
{
    public class FamilyKeyPage : ContentPageBase
    {
        ...
        public FamilyKeyPage(FamilyKeyPageViewModel viewModel) : base(viewModel)
        {
            ...
            characterListView.ItemTemplate = new CharacterDataTemplateSelector();
            ...
            var resultsLayout = new StackLayout { Orientation = StackOrientation.Horizontal, Children = { resultLabel,  viewResultsButton } };

            var layout = new StackLayout { Children = {characterListView, resultsLayout } };
            ...
            protected override DataTemplate OnSelectTemplate(object item, BindableObject container)
            {
                ...
                else if (item is FamilyKeyPageViewModel.PickerDisplayItem)
                {
                    return new DataTemplate(() => {
                        ...
                        var valuePicker = new Xamarin.Forms.Picker { TextColor = Color.White, VerticalTextAlignment = TextAlignment.Center, HorizontalOptions = LayoutOptions.FillAndExpand, FontSize = Device.GetNamedSize(NamedSize.Small, typeof(Label)), BackgroundColor = Color.DarkGray.MultiplyAlpha(0.5) };
                        valuePicker.SetBinding(Xamarin.Forms.Picker.ItemsSourceProperty, new Binding(nameof(FamilyKeyPageViewModel.PickerDisplayItem.Options), BindingMode.OneWay));
                        valuePicker.SetBinding(Xamarin.Forms.Picker.SelectedItemProperty, new Binding(nameof(FamilyKeyPageViewModel.PickerDisplayItem.SelectedOptionId), BindingMode.TwoWay));
