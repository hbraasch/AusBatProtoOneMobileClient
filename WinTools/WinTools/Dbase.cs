...
namespace AusBatProtoOneMobileClient.Models
{
    public class Dbase
    {
        ...
        static string folderPath = @"c:\temp\data";
        ...
        public async Task Init()
        {
            try
            {
                ...
                dbase.Bats.Add(new Bat { GenusId = "Vespadelus", SpeciesId = "troughtoni", Name = "Eastern Cave Bat", DataTag = "Vesp_trought" });
        ...
        {
            if (selectedRegions.Count == 0) return bats;
